...
A(Entity &, get_entity_by_index, (u32 index), (index)) \
A(u32, get_entity_index, (Entity &entity), (entity)) \
A(ComponentInfo &, get_component_info, (ComponentUID uid), (uid)) \
A(void, free_component_storages, (), ()) \

#define A(ret, name, args, params) extern ret (*_##name) args; inline ret name args { return _##name params; }
T3D_APIS(A)
#undef A
