...
void draw_property(Span<utf8> name, v3f &value, u64 id, std::source_location location) {
	...
	push_viewport(x_viewport) float_field(value.x, id * 3 + 0, location);
	push_viewport(y_viewport) float_field(value.y, id * 3 + 1, location);
	push_viewport(z_viewport) float_field(value.z, id * 3 + 2, location);
...
void draw_property(Span<utf8> name, List<utf8> &value, u64 id, std::source_location location) {
	...
	push_viewport(line_viewport) text_field(value, id, location);
